...
<nav class="navbar navbar-light navbar-expand-md navigation-clean" style="background-color: #5026D1;">
    <div class="container">
        <a class="navbar-brand" href="#" style="font-family: 'Great Vibes'; letter-spacing: 2px; padding-right: 15px; font-weight: lighter; color: rgb(255, 255, 255);font-size: 38px;" name="company_name"><?=$contact_info[3]?></a>
