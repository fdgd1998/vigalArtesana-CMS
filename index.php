...
<body>
    ...
    <div class="container content">
        ...
        <div>
            <button style="margin-top: 10px;" onclick="window.location.href = 'sobremi.php'" type="button" class="btn my-button">Leer más</button>
            <button style="margin-top: 10px;" onclick="window.location.href = 'galeria.php'" type="button" class="btn my-button">Ver galería</button>
        </div>
    </div>
    <div class="container">
        <div class="row">
            <div class="col-6">
                <h3 class="mb-3 text-left">Servicios</h3>
            </div>
    ...
    <div class="container content">
        ...
        <p>Consulta los datos de contacto pinchando en el botón de abajo.</p>
        <button style="margin-top: 10px;" onclick="window.location.href = 'contacto.php'" type="button" class="btn btn-light my-button shadow-none">Contacto</button>
    </div>
