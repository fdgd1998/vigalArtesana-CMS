    ...
    <div class="container">
        <div class="row">
            <div class="col-12 col-sm-5 col-md-3 footer-links">
                <ul>
                    <li><a href="/politica-privacidad"><i class="fas fa-user-secret" style="margin-right: 5px;"></i>Política de privacidad</a></li>
                    <li><a href="/aviso-legal"><i class="fas fa-balance-scale" style="margin-right: 5px;"></i>Aviso legal</a></li>
                    <?php
                        if (!isset($_SESSION['user'])) {
                            echo '<li><a href="/login"><i class="fas fa-sign-in-alt" style="margin-right: 5px;"></i>Iniciar sesión</a></li>';
                        } else {
