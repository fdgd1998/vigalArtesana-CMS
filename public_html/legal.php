...
<head>
    ...
    <title>Aviso legal - <?=$GLOBALS["site_settings"][2]?></title>
...
<body>
    <div id="main">
        ...
        <div class="container content">
            ...
            <h2 class="title">1. Información legal</h2>
            ...
            <h2 class="title">3. Acceso y utilización del sitio web.</h2>
            ...
            <h2 class="title">4. Protección de datos personales</h2>
            ...
            <h2 class="title">5. Propiedad intelectual e industrial</h2>
            ...
            <h2 class="title">6. Exclusión de garantías y responsabilidad</h2>
            ...
            <h2 class="title">8. Derecho de exclusión</h2>
            ...
            <h2 class="title">9. Generalidades</h2>
